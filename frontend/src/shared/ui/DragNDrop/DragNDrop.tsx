...
export const DragNDrop = () => {
  ...
  const updateFile = useDownloadStore(state => state.updateFile)
  ...
  return (
    <div className="relative">
            {file && (
            <div className="absolute -top-3 -right-3 z-10 bg-black rounded-full text-white w-7 h-7 flex justify-center items-center transition cursor-pointer hover:scale-125"
              onClick={() => {
                updateFile(null)
                setVideoSrc(null)}}
            >X</div>
            ...
            <label 
              htmlFor="file" 
              className={cx(`flex min-h-[175px] w-full cursor-pointer items-center justify-center rounded-md border border-dashed p-6 transition`,
            ...
            >
               <div>
                <div className="text-center">Upload your video</div>
                  <input 
                    type="file" 
                    name="file" 
                    id="file" 
                  ...
                  <span className="mx-auto my-3 flex h-[50px] w-[50px] items-center justify-center rounded-full border border-stroke dark:border-dark-3 bg-white dark:bg-dark-2">
